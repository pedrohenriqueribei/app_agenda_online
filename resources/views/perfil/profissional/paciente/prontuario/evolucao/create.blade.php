...
@section('title', 'Registro de evolução do paciente')

@section('content')

    <h1 class="titulo_1">Registro de Evolução do Trabalho</h1>
    ...
    <form action="{{ route('perfil.profissional.paciente.prontuario.psicologico.evolucao.store', [$profissional, $paciente, $prontuario_psicologico]) }}" method="POST" class="space-y-6">
        @csrf
